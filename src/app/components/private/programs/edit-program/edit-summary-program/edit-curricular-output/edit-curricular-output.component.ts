...
@Component({
  selector: 'app-edit-curricular-output',
  templateUrl: './edit-curricular-output.component.html',
  styleUrls: ['./edit-curricular-output.component.scss'],
})
export class EditCurricularOutputComponent implements OnInit {
