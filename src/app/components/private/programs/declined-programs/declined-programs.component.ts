...
@Component({
  selector: 'app-declined-programs',
  templateUrl: './declined-programs.component.html',
  styleUrls: ['./declined-programs.component.scss'],
})
export class DeclinedProgramsComponent implements OnInit {
