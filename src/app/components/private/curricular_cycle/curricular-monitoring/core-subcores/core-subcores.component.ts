...
@Component({
  selector: 'app-core-subcores',
  templateUrl: './core-subcores.component.html',
  styleUrls: ['./core-subcores.component.scss'],
})
export class CoreSubcoresComponent implements OnInit {
