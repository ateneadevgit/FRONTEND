...
@Component({
  selector: 'app-module-syllabus',
  templateUrl: './module-syllabus.component.html',
  styleUrls: ['./module-syllabus.component.scss'],
})
export class ModuleSyllabusComponent implements OnInit {
